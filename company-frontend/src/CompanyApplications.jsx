...
const CompanyApplications = () => {
  ...
  const fetchApplications = () => {
    ...
    if (storedUser) {
      ...
      fetch(`https://www.careerspott.com/api/auth/company/${storedUser.userId}/applications`)
        .then(res => {
          if (!res.ok) {
  ...
  const handleResumeDownload = async (applicationId, fullName) => {
    try {
      ...
      const viewResponse = await fetch(`https://www.careerspott.com/api/auth/application/${applicationId}/view`, {
        method: 'PUT'
      });
      ...
      if (viewResponse.ok) {
        ...
        const resumeUrl = `https://www.careerspott.com/api/auth/resume/${applicationId}`;
  ...
  const handleShortlist = (application) => {
    ...
    fetch(`https://www.careerspott.com/api/auth/application/${application.id}/respond`, {
      method: 'POST',
      headers: {
  ...
  const sendResponse = () => {
    ...
    fetch(`https://www.careerspott.com/api/auth/application/${selectedApplication.id}/respond`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
