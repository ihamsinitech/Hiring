...
const Messages = () => {
  ...
  useEffect(() => {
    ...
    if (userData && userData.userId) {
      fetch(`https://www.careerspott.com/api/auth/student/${userData.userId}/messages`)
        .then(res => res.json())
        .then(data => {
  ...
  const sendReply = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://www.careerspott.com/api/auth/application/${selectedMessage.id}/student-reply`, {
        method: 'POST',
        headers: {
