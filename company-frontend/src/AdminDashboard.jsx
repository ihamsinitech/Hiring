...
const AdminDashboard = () => {
    ...
    const fetchDashboardData = async () => {
        try {
            ...
            const response = await axios.get('http://www.careerspott.com/api/admin/dashboard', {
                headers: {
...
const StudentsTab = () => {
    ...
    const fetchStudents = async () => {
        try {
            setError('');
            const response = await axios.get('http://www.careerspott.com/api/admin/students');
...
const CompaniesTab = () => {
    ...
    const fetchCompanies = async () => {
        try {
            setError('');
            const response = await axios.get('http://www.careerspott.com/api/admin/companies');
...
const JobsTab = () => {
    ...
    const fetchJobs = async () => {
        try {
            setError('');
            const response = await axios.get('http://www.careerspott.com/api/admin/jobs');
...
const ApplicationsTab = () => {
    ...
    const fetchApplications = async () => {
        try {
            setError('');
            const response = await axios.get('http://www.careerspott.com/api/admin/applications');
